var table: any = {
	...
	"channel": {name: "table_channel", sql: `create table if not exists (id integer primary key, reference integer, description text);`},
	...
	"image": {name: "table_media_image", sql: `create table if not exists (id integer primary key, reference integer, name text, slug text, type text, type_of text, file text, description text);`},
	"genre": {name: "table_genre", sql: `create table if not exists (id integer primary key, reference integer, name text, slug text, icon text, thumbnail text not null default '{}', description text);`},
